...
'                   <div class="forecast__card">' +
    ...
    '                      <span class="weather__temp-val forecast__temp-val forecast__temp--min">{{ this.mintemp_c }}</span>' +
    '                      <span class="weather__temp-unit">°...</span>' +
    '                      <span class="weather__temp-val forecast__temp-val forecast__temp--max">{{ this.maxtemp_c }}</span>' +
    '                      <span class="weather__temp-unit">°</span>' +
    '                  </div>' +
    '                   <ul class="weather-fields-list forecast__fields-list">' +
    '                      <li class="weather-field forecast-field">' +
    '                          <svg class="field__img field__img--dark"><use xlink:href="#wind"></use></svg>  ' +
    '                          <p class="field__content field__content--wind">' +
    '                              <span class="field__val js-field__wind-speed">{{ this.maxwind_kph }}</span>' +
    '                              <span class="field__unit"> м/с</span>' +
    '                          </p>' +
    '                      </li>' +
    '                      <li class="weather-field forecast-field">' +
    '                          <svg class="field__img field__img--dark"><use xlink:href="#mist"></use></svg>' +
    '                          <p class="field__content field__content--humidity">' +
